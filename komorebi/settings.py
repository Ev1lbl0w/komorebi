...
class Settings:
    ...
    def load_settings():
        ...
        Settings.wallpaper_name = Settings._optional(Settings._config_key_file.get_string(Settings.key_file_group, ConfigKeys.WALLPAPER_NAME.value), 'foggy_sunny_mountain')
        Settings.time_twenty_four = Settings._optional(Settings._config_key_file.get_boolean(Settings.key_file_group, ConfigKeys.TIME_TWENTY_FOUR.value), True)
        Settings.autostart = Settings._optional(Settings._config_key_file.get_boolean(Settings.key_file_group, ConfigKeys.AUTOSTART.value), False)
        Settings.show_desktop_icons = Settings._optional(Settings._config_key_file.get_boolean(Settings.key_file_group, ConfigKeys.SHOW_DESKTOP.value), True)
        Settings.enable_video_wallpapers = Settings._optional(Settings._config_key_file.get_boolean(Settings.key_file_group, ConfigKeys.ENABLE_VIDEO.value), True)
        Settings.mute_playback = Settings._optional(Settings._config_key_file.get_boolean(Settings.key_file_group, ConfigKeys.MUTE_PLAYBACK.value), False)
        Settings.pause_playback = Settings._optional(Settings._config_key_file.get_boolean(Settings.key_file_group, ConfigKeys.PAUSE_PLAYBACK.value), True)
